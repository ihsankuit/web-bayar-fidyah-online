/**
 * Brand marks for the social links in the footer.
 *
 * lucide-react dropped its brand icons over trademark concerns, so these are
 * inlined rather than imported. Each is the official glyph, used only to link
 * to that platform's own profile — the standard nominative use.
 *
 * They inherit `currentColor` and size from the parent, so they style exactly
 * like the lucide icons alongside them.
 */
